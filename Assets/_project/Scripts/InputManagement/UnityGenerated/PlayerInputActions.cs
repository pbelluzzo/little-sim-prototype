...
namespace LittleSimPrototype.InputManagement
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""InteractAction"",
                    ""type"": ""Button"",
                    ""id"": ""9c376b3d-f99c-4019-905e-867f7e39ba92"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""182b479d-faf4-41d4-845e-d20bf150e46a"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
            ...
            m_CharacterMap_InteractAction = m_CharacterMap.FindAction("InteractAction", throwIfNotFound: true);
        }
        ...
        private readonly InputAction m_CharacterMap_InteractAction;
        public struct CharacterMapActions
        {
            ...
            public InputAction @InteractAction => m_Wrapper.m_CharacterMap_InteractAction;
            ...
            public void SetCallbacks(ICharacterMapActions instance)
            {
                if (m_Wrapper.m_CharacterMapActionsCallbackInterface != null)
                {
                    ...
                    @InteractAction.started -= m_Wrapper.m_CharacterMapActionsCallbackInterface.OnInteractAction;
                    @InteractAction.performed -= m_Wrapper.m_CharacterMapActionsCallbackInterface.OnInteractAction;
                    @InteractAction.canceled -= m_Wrapper.m_CharacterMapActionsCallbackInterface.OnInteractAction;
                }
